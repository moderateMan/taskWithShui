...
import Carousel, { CarouselDots, useCarousel } from 'src/commonOld/components/carousel';
...
export default function LandingHero({ tours }: Props) {
    ...
    >
      ...
      >
        ...
        <Button variant="contained" size="large" color="primary" onClick={ 
          () => router.push(`/auth/register-cover`)
        }>
          Join Now
        </Button>
      </Stack>

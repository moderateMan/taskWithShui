  ...
  return useMemo<FormConfig>(() => {
    ...
    let config: FormConfig = {
      ...
      amount: {
        ...
        schema: [DealType.CAPITAL_RAISING, DealType.SELL_A_BUSINESS].includes(targetType!)
        ...
        label: `Amount ${[DealType.CAPITAL_RAISING, DealType.SELL_A_BUSINESS].includes(targetType!) ? '' : '(optional)'
          }`,
        wrapper: ({ children }) => {
          return (
            <FromWrapper
      ...
      ask_desc: {
        ...
        label: `Ask Description ${[DealType.STARTUP_PITCH].includes(targetType!) ? '' : '(optional)'}`,
        wrapper: ({ children }) => {

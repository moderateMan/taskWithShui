...
export const paths = {
  ...
  account: {
    ...
    deals: `/account/deals`,
    dealEdit: `/account/deals/edit`,
    postDeal: `/account/post-deal`,
    opportunity: '/account/post-opportunity',
  ...
  verify: '/auth/email/success',
  ResendEmailVerification: '/auth/resend-email-token',
  ...
  travel: {
    ...
    userRequest: '/travel/user-request',
  },
  // Career
  career: {
    root: '/career',
  ...
  eCommerce: {
    ...
    account: {
      ...
      deals: `/e-commerce/account/deals`,
      postDeal: `/e-commerce/account/post-deal`,
      vouchers: `/e-commerce/account/vouchers`,
      orders: `/e-commerce/account/orders`,
      enquiries: `/e-commerce/account/enquiries`,
      payment: `/e-commerce/account/payment`,
      company: `/e-commerce/account/company`,
      notification: `/e-commerce/account/notification`,
      connection: `/e-commerce/account/connection`,
    },
  },
  // Components
  components: {
  ...
  userInfo: '/e-commerce/account/personal',
};
